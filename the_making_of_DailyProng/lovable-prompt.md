# Lovable Prompt: Powerhouse Learning System

Build a private, single-user daily learning web application called "Powerhouse." It's a goal-driven learning engine that generates personalized daily learning units using the Anthropic Claude API. The app replaces a markdown-file-based Cowork setup with a proper UI.
...
2. Constructs a system prompt that includes:
   - Role description ("You are the Powerhouse learning system...")
