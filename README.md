...
2. Open Claude Desktop → switch to Cowork → point the working folder on `plugin/`
...
- **Autopilot mode:** Want units pre-generated when you open Cowork? Go to the Scheduled Tasks tab in Claude Desktop and create a daily task pointing at the `plugin/` folder. The system will generate your next unit at your preferred time — or skip gracefully if feedback is still pending.
